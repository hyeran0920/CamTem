...
function LoginPage() {
  ...
  const handleKakaoLogin = (event) => {
    ...
    const KakaoLoginUrl =
      "https://kauth.kakao.com/oauth/authorize?client_id=62342a0268dc6bfdf0a67b0d5b7c6cb7&redirect_uri=http://choongbuck.s3-website.ap-northeast-2.amazonaws.com/oauth2/kakao&response_type=code&prompt=login";
