    ...
    <Container fluid style={{ fontFamily: "SUITE-Regular" }} id="productdetail">
      ...
      <div id="entire">
        <div className="firstContainer">
          ...
          <div className="CampIntro">
            ...
            <div className="button-container">
              ...
              {camping.resveUrl ? (
                <button className="camp-button">
                  <a href={camping.resveUrl} target="_blank" rel="noopener noreferrer" className="button-link">
                    캠핑장 예약하기
                  </a>
                </button>
              ) : null}
              ...
              {!camping.homepage && !camping.resveUrl && (
                <button className="no-info-button">예약 정보가 없습니다</button>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="ProductDetail" id="clickCampingIntro">
          ...
          <Nav justify variant="tabs" className="justify-content-center navBar">
            <Nav.Item>
              ...
              {filteredFacilities.map((facility, index) => (
                <div className="facility-icon-container" key={index}>
                  <div className="facility-content">
                    {iconMap[facility] && (
                      <div className="facility-icon">{React.cloneElement(iconMap[facility], { size: "3.00rem" })}</div>
                    )}
                    <div className="facility-text">{facility}</div>
                  </div>
                </div>
              ))}
            </div>
