...
function ProductDetail() {
    ...
    return (
        ...
        <Container fluid style={{ margin: 0, padding: 0 ,fontFamily: "SUITE-Regular"}}>
            {/* TopNav */}
                ...
                <div className="firstContainer" style={{ display: "flex", alignItems: "center" }}>
                    ...
                    <div className="CampIntro" style={{ marginLeft: "5%", marginRight: "5%" }}>
                        ...
                        <div style={{ textAlign: "right" }}>
                            <button style={{ backgroundColor: "darkcyan", color: "white", padding: "7px 17px", border: "none",fontSize:"20px",borderRadius:"5px" }}>
                                예약하기
                            </button>
                        </div>
                    </div>
            ...
            흰색으로 탭이 칠해지면 어떤지??*/}
                <div className="ProductDetail" id="clickCampingIntro">
                    ...
                    <div className="shortInfo-payment" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", margin: "0 0", padding: "0 0" }}>
                        ...
                        <div style={{ display: "flex", width: "80%", margin:"0 auto" }}>
                            <br />
                            <h6 className="campingShortInfo" style={{ width: "100%", whiteSpace: "pre-wrap", textAlign: "initial",fontSize:"18px" }}>{content?.intro}
                                <br />
                                <br />
                                {content?.featureNm}
                ...
                <div id="clickUseInfo" style={{ display: "flex", justifyContent: "center", alignItems: "center", height: "300px" }}>
                    <div style={{ backgroundColor: "#f5f5f5", width: "80%", height: "50%",margin:"0 auto", padding:"20px", borderRadius:"10px" }}>
                        {content?.sbrsCl}
                    </div>
                </div>
                <div className="hr" style={{ width: '100%', margin: '0 auto' }}>
