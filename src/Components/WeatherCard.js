...
function WeatherCard({ weather }) {
  ...
  return (
    <Card
      ...
      text="white"
      style={{ margin: "10px", border: "none", backgroundColor: "#73C2FB", width: "100%" }}
    >
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <div>
            <span>
              ...
              <span style={{ fontWeight: "bold", color: "#FF5B5B" }}>{Math.floor(weather.temp.max)} °C</span>
            </span>
            <br />
            <span style={{ fontSize: "13px" }}>강수확률: {weather.pop * 100}%</span>
            {weather.rain && weather.rain["3h"] !== undefined && (
              <span>
                <br /> 강수량: {weather.rain["3h"]} mm
              </span>
            )}
          </div>
        </div>
