      ...
      <div style={containerStyle}>
        <div style={formContainerStyle}>
          <form action="/login" method="post" style={formStyle}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', width: '100%', fontSize: '13px', color: 'lightgray' }}>
              <Nav.Link onClick={() => navigate('/FindMemberInfoPage')} style={{ color: 'lightgray', textDecoration: 'none' }}>
                아이디/비밀번호 찾기
              </Nav.Link>
              <Nav.Link onClick={() => navigate('/RegisterPage')} style={{ color: 'lightgray', textDecoration: 'none' }}>
                회원가입
              </Nav.Link>
            </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '20px', width: '100%' }}>
              ...
              <button type="button" style={kakaoButtonStyle} onClick={KakaoLogin}>
                카카오
              </button>
            </div>
          </form>
